...
directory before opening Claude. It serves both the Fabric tools and the
graph tools at the URL in `FABRIC_SERVER_URL`. If `tools/list` returns
nothing the container probably isn't running.
