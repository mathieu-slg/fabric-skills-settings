...
The server exposes only tools that DON'T require ms-fabric-cli — graph,
content, lint, validate, data, semantic-model (uses sempy.fabric python lib),
precommit. Fabric-CLI-dependent helpers live in cli/ and run on the user's
laptop as plain CLI commands (Claude invokes them via Bash).
"""
...
from .tools.lint import tools as lint_tools
from .tools.precommit import tools as precommit_tools
